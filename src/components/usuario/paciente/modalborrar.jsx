...
export default function Clasenueva(props) {
    ...
    const handleDeterminar = async (event) => {
        ...
        try {
         ...
         const respuesta=  await servicioDtc.borrarpaciente({id:props.id})
         alert(respuesta)
    ...
    return (
        <div>
            ...
            <Button variant='outlined' sx={{ color: "red", borderColor: "red", fontSize: "0.70rem", }} onClick={handleClickOpen} /* style={{ width: '25%' }} */ >
            Borrar Paciente
            </Button>
